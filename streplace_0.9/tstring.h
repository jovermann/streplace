...
//
// Copyright (c) 1997-2022 Johannes Overmann
//
...
/// split string into pieces by characters in c-str separator
/// allow separators to be backslash escaped
tvector<tstring> splitAndAllowBackslashEscapedSeparator(const tstring &s, const char *sep);
